...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = sensor_data.export_data_into_feature_store(collection_name=self.data_ingestion_config.collection_name)
    ...
    def split_data_as_train_test(self,dataframe: DataFrame) ->None:
        ...
        try:
            ...
            logging.info("perform train test split on dataset")
            logging.info("Exited split_data_as_train_test method of Data_Ingestion class"
            )
            dir_path = os.path_dirname(self.data_ingestion_config.training_file_path)
